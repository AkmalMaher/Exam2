...
function openSideNav() {
  ...
  $(".inOutBtn").removeClass("fa-align-justify");
  $(".inOutBtn").addClass("fa-x");
...
function closeSideNav() {
  let boxWidth = $(".sideBar-menu .nav-inner").outerWidth();
  $(".sideBar-menu").animate(
    {
      left: -boxWidth,
    },
  ...
  $(".inOutBtn").addClass("fa-align-justify");
  $(".inOutBtn").removeClass("fa-x");
...
function myContact() {
  rowData.innerHTML = `<div class="contact min-vh-100 d-flex justify-content-center align-items-center">
    <div class="container w-75 text-center">
        ...
        <button id="submitBtn" disabled class="btn btn-outline-danger cursor-pointer px-2 mt-3">Submit</button>
    </div>
</div> `;
